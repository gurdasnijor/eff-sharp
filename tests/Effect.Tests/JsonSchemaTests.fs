    ...
    let input =
        jo
            [ "enum", ja [ js "a"; js "b"; js "c" ]
              ...
              "allOf",
              ja
                  [ jo [ "type", js "array"; "items", jo [ "type", js "string" ] ]
                    jo [ "minItems", jn 1.0 ] ]
              "anyOf",
              ja
                  [ jo [ "type", js "array"; "items", ja [ jo [ "type", js "string" ] ] ]
                    jo [ "type", js "number" ] ]
              "oneOf",
              ja
                  [ jo
        ...
        doc
            ...
            (jo
                [ "enum", ja [ js "a"; js "b"; js "c" ]
                  ...
                  "anyOf",
                  ja
                      [ jo [ "type", js "array"; "prefixItems", ja [ jo [ "type", js "string" ] ] ]
                        jo [ "type", js "number" ] ]
                  "oneOf",
                  ja
                      [ jo
...
let ``toDraft07 rewrites refs and lowers tuples`` () =
    ...
    let expected =
        doc
            ...
            (jo
                [ "type", js "object"
                  "properties", jo [ "a", jo [ "$ref", js "#/definitions/A" ] ] ])
            [ "A", jo [ "type", js "string"; "$ref", js "#/definitions/B" ]
              "B", jo [ "type", js "number" ] ]
    ...
    let input =
        { Dialect = Draft2020_12
          Schemas =
            [ jo
                  [ "type", js "object"
                    "properties", jo [ "A.B", jo [ "$ref", js "#/$defs/A$B" ] ] ] ]
    ...
    let expected =
        { Dialect = OpenApi31
          Schemas =
            [ jo
                  [ "type", js "object"
                    "properties", jo [ "A.B", jo [ "$ref", js "#/components/schemas/A_B" ] ] ] ]
          Definitions =
            Map.ofList
